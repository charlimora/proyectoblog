    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            {{--botón notificación. Si se quita, el icono ya no actuará como botón--}}
           <button type="button" class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
            {{--<span class="sr-only">View notifications</span>--}}
            <!-- lo siguiente es el icono svg mismo con aparienca de campana -->
          ...
          <div class="ml-3 relative" x-data="{ open: false}">
            ...
            <div x-show="open" x-on:click.away= "open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Herramientas</a>
              <form method="POST" action="{{ route('logout') }}">
                @csrf
            {{--en Javascript, preventDefault cancela cancela un evento
                El método form.submit() permite iniciar el envío del formulario mediante JavaScript. --}}
